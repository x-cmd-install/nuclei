...
合计: **125,980** 行代码（覆盖前 5 种语言、共 **1184** 个文件）。
...
- **Star**: 31,104 · **Fork**: 3,852 · **开放 issue**: 2,956 · **贡献者**: 256

## 累计统计

- **发布数**: 147 · **已合并 PR**: 2789 · **开放 PR**: 52 · **已关闭 issue**: 2900 · **开放 issue**: 56 · **提交数**: 6540
...
在 [repology.org](https://repology.org/project/nuclei) 上共有 **43** 个发行版报告此项目。**13** 个 ✅ 已是最新上游版本，**27** 个 ⚠️ 使用旧版本。
