...
合计: **128,919** 行代码（覆盖前 5 种语言、共 **1190** 个文件）。
...
- **上游仓库**: <https://github.com/projectdiscovery/nuclei>
...
- **Star**: 31,229 · **Fork**: 3,869 · **开放 issue**: 2,961 · **贡献者**: 256

## 累计统计

- **发布数**: 147 · **已合并 PR**: 2792 · **开放 PR**: 42 · **已关闭 issue**: 2901 · **开放 issue**: 60 · **提交数**: 6549

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-17 | 0 | 25 | 10 | 11 | 8 | 46 |
| last60d | 2026-07-18 | 1 | 66 | 32 | 37 | 14 | 103 |
| 90d | 2026-06-18 | 3 | 100 | 38 | 63 | 18 | 137 |
| last180d | 2026-03-20 | 5 | 189 | 41 | 110 | 21 | 256 |
| 360d | 2025-09-21 | 12 | 366 | 42 | 265 | 22 | 547 |
| last720d | 2024-09-26 | 31 | 639 | 42 | 574 | 30 | 1171 |
...
nuclei 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `nuclei` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/nuclei.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260916.yml` · 2026-09-16T04:40:58Z._
